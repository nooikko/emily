...
@Module({
  ...
  providers: [RabbitMQConnectionService, QueueManagerService, QueueHealthMonitorService],
  exports: [RabbitMQConnectionService, QueueManagerService, QueueHealthMonitorService],
})
